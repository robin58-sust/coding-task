<style>
	...
	<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Shipping Order List </h1>
                    </div>
                </div>
                 <div class="row">
					<?php 
                             ...
                             <table class="table table-bordered table-hover table-striped" id="example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
										...
										<td style="color: #25258e;font-weight: 700;" ><?php echo substr($orders_arr->name,0,15); ?></td>
										<td><?php echo $orders_arr->mobile; ?></td>
										<td><?php echo $orders_arr->delivery_man;?></td>
										<td>
										<?php 
										...
										<td>
											<a href="<?php echo base_url();?>order/view/<?php echo $orders_arr->id; ?>" class="btn btn-xs btn-info"><i class="fa fa-print"></i></a>
